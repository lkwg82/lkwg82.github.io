...
(function () {
    ...
    t.l = function (a, c) {
        ...
        c = t.rc(c);
        d.W && d.W.call(a, c);
        if (e && !c.Jb() && c.bubbles !== l)t.l(e, c); else if (!e && !c.defaultPrevented && (d = t.getData(c.target), c.target[c.type])) {
            d.disabled = f;
    ...
    s.wc = function () {
        ...
        if (d = c.children)if (h = function (d, e) {
            c[d] !== b && (e = c[d]);
            e !== l && (a[d] = a.V(d, e))
        }, t.g.isArray(d))for (var j = 0; j < d.length; j++)e = d[j], "string" == typeof e ? (g = e, e = {}) : g = e.name, h(g, e); else t.g.X(d, h)
    };
    s.T = q("");
    s.c = function (a, c, d) {
        var e, g, h;
    ...
    s.Z = function (a) {
        if (37 == a.which || 40 == a.which)a.preventDefault(), this.Nc(); else if (38 == a.which || 39 == a.which)a.preventDefault(), this.Oc()
    };
    s.Xa = function () {
        t.j(document, "keyup", t.bind(this, this.Z))
    };
    ...
    s.volume = function (a) {
        if (a !== b)return a = Math.max(0, Math.min(1, parseFloat(a))), this.G.volume = a, T(this, "setVolume", a), t.ae(a), this;
    ...
    s.exitFullscreen = function () {
        var a = t.Oa.Fb;
        this.isFullscreen(l);
        if (a)document[a.exitFullscreen](); else this.o.Ea() ? T(this, "exitFullScreen") : (this.Cb(), this.l("fullscreenchange"));
        return this
    };
        ...
        for (var c = 0, d = this.m.techOrder; c < d.length; c++) {
            ...
            if (g) {
                if (g.isSupported())for (var h = 0, j = a; h < j.length; h++) {
                    var n = j[h];
                    if (g.canPlaySource(n))return{source: n, o: e}
                }
    ...
    s.xa = function () {
        ...
        if (c)for (var d = c.length - 1; 0 <= d; d--)a.V(new t.nb(this.k(), {rate: c[d] + "x"}));
        return a
    };
    s.oa = function () {
    ...
    s.e = function () {
        ...
        if (!c || this.movingMediaElementInDOM === l)c ? (d = c.cloneNode(l), t.h.Bb(c), c = d, a.I = k) : (c = t.e("video"), t.Kc(c, t.g.z(a.ie || {}, {id: a.id() + "_html5_api", "class": "vjs-tech"}))), c.player = a, t.Hb(c, a.w());
    ...
    function Y(a, c, d) {
        for (var e = a.Fa, g = 0, h = e.length, j, n; g < h; g++)j = e[g], j.id() === c ? (j.show(), n = j) : d && (j.M() == d && 0 < j.mode()) && j.disable();
        ...
        if (0 < this.ca.length) {
            ...
            if (this.Pb === b || a < this.Pb || this.Wa <= a) {
                ...
                for (; ;) {
                    ...
                    } else g ? (h.splice(0, 0, r), n === b && (n = w), j = w) : (h.push(r), j === b && (j = w), n = w), d = Math.min(d,
    ...
    t.mb.prototype.update = function () {
        for (var a = this.d.textTracks(), c = 0, d = a.length, e, g = f; c < d; c++)e = a[c], e.M() == this.ea.M() && 2 == e.mode() && (g = l);
        this.selected(g)
    };
    ...
    t.U.prototype.wa = function () {
        ...
        for (var d = 0; d < this.d.textTracks().length; d++)c = this.d.textTracks()[d], c.M() === this.H && a.push(new t.aa(this.d, {track: c}));
        return a
    };
    ...
    s.wa = function () {
        for (var a = [], c, d = 0; d < this.d.textTracks().length; d++)c = this.d.textTracks()[d], c.M() === this.H && a.push(new t.aa(this.d, {track: c}));
        return a
    };
    s.xa = function () {
        for (var a = this.d.textTracks(), c = 0, d = a.length, e, g, h = this.Q = []; c < d; c++)if (e = a[c], e.M() == this.H)if (0 === e.readyState())e.load(), e.c("loaded", t.bind(this, this.xa)); else {
            g = e;
            break
        }
        a = this.Ba;
        ...
        if (g) {
            e = g.ca;
            for (var j, c = 0, d = e.length; c < d; c++)j = e[c], j = new t.gb(this.d, {track: g, cue: j}), h.push(j), a.V(j);
            this.V(a)
        }
    ...
    if ("undefined" !== typeof window.JSON && "function" === typeof window.JSON.parse)t.JSON = window.JSON; else {
        ...
        t.JSON.parse = function (a, c) {
            function d(a, e) {
                var j, n, r = a[e];
                if (r && "object" === typeof r)for (j in r)Object.prototype.hasOwnProperty.call(r, j) && (n = d(r, j), n !== b ? r[j] = n : delete r[j]);
                return c.call(a, e, r)
            }
    ...
    t.jc = function () {
        ...
        if (g && 0 < g.length) {
            d = 0;
            for (e = g.length; d < e; d++)if ((c = g[d]) && c.getAttribute)c.player === b && (a = c.getAttribute("data-setup"), a !== k && videojs(c)); else {
                t.ub();
                break
            }
        } else t.Uc || t.ub()
